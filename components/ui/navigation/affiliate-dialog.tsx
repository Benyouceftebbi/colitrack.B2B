...
// Mock shopData object - replace with actual data from your backend
const shopData = {
  affiliate: {
    code: "GOLD2024",
    referrals: 12,
    ...
    levels: [
      {
        ...
        requiredReferrals: 5,
        commission: 5,
        rewards: ["5% commission on all referrals", "Access to affiliate dashboard", "Monthly newsletter with tips"],
      },
      {
        level: 2,
        name: "Silver",
        ...
        commission: 10,
        rewards: ["10% commission on all referrals", "Priority support", "Exclusive promotional materials"],
      },
      {
        level: 3,
        name: "Gold",
...
export function AffiliateDialog({
  ...
  const copyToClipboard = () => {
    ...
    toast({
      ...
      description: `Affiliate code ${affiliate.code} copied!`,
    })
  ...
  const shareAffiliate = () => {
    ...
    const shareMessage = `Join using my affiliate code ${affiliate.code} and get a special discount!`
        ...
        <ScrollableContent className="mt-4 space-y-6">
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <span>
                {displayLevel.name} Affiliate (Level {displayLevel.level})
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="font-medium">{displayLevel.commission}% Commission Rate</span>
              </div>
              <span className="text-sm text-muted-foreground">{affiliate.referrals} Referrals</span>
            </div>
            ...
            {!isMaxLevel && (
              <>
                ...
                <div className="flex justify-between text-sm">
                  <span>Level {displayLevel.level}</span>
                  <span className="text-muted-foreground">
                    {nextLevel.requiredReferrals - affiliate.referrals} more to Level {nextLevel.level}(
                    {nextLevel.commission}% commission)
                  </span>
                </div>
              </>
            )}
            ...
            {isMaxLevel && (
              <div className="text-center text-sm font-medium text-green-600">
                Congratulations! You've reached the maximum affiliate level.
              </div>
            )}
          </div>
          ...
          <div className="rounded-lg border p-4">
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-green-600">{affiliate.earnings}</div>
            </div>
          </div>
          ...
          <div className="rounded-lg border p-4 space-y-4">
            <div>
              <h3 className="font-medium flex items-center gap-2">
                ...
                Current Level: {displayLevel.name}
              </h3>
              <div className="mt-2 text-sm">
                ...
                <div className="mt-2">
                  ...
                  <ul className="mt-1 space-y-1">
                    {displayLevel.rewards.map((reward, index) => (
            ...
            <div className="rounded-lg border border-dashed p-4 space-y-4">
              <div>
                ...
                <div className="mt-2 text-sm">
                  ...
                  <div className="mt-2">
                    <span className="font-medium">Unlock These Rewards:</span>
                    <ul className="mt-1 space-y-1">
          ...
          <div className="rounded-lg bg-muted/30 p-4">
            <h3 className="font-medium mb-2">How to Earn More</h3>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>Share your affiliate code with friends and colleagues</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-primary/10 text-primary flex-shrink-0 mt-0.5">
                  2
                </div>
                <span>Post your code on social media with product recommendations</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-primary/10 text-primary flex-shrink-0 mt-0.5">
                  3
                </div>
                <span>Create content featuring your affiliate products</span>
              </li>
            </ul>
          </div>
        </ScrollableContent>
