...
export const STEPS = ["Select Audience", "Message Type", "Craft Message", "Preview & Test", "Send Campaign"];
export const STEPS_UNIQUE = ["Select Audience", "Message Type", "Message Stats", "Preview & Test", "Send Campaign"];
