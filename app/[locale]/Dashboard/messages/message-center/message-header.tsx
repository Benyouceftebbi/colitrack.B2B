      ...
      <div className="flex flex-col space-y-6">
              ...
              <Popover>
                ...
                <PopoverContent className="glass w-80 max-w-[95vw]">
                  <div className="space-y-4">
                    ...
                    <Separator />
                    <div className="space-y-2">
                      <p className="text-sm">Automated messaging system for:</p>
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                ...
                >
                  ...
                  {token ? `${shopData.deliveryCompany}` : 'No delivery company'}
                </Badge>
              </HoverCardTrigger>
              <HoverCardContent className="glass w-80">
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-semibold">Delivery Integration</h4>
                  </div>
                  <Separator />
                  <p className="text-sm">
                    {token
                      ? `Connected with ${shopData.deliveryCompany}. Manage delivery settings and automation rules.`
                      : "Connect your delivery service to enable automated tracking and notifications."}
                  </p>
                </div>
              </HoverCardContent>
            </HoverCard>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
          ...
          <div className="glass rounded-lg p-4 hover:scale-105 transition-transform duration-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Delivery Updates</p>
