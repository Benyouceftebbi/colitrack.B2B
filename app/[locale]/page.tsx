      ...
      <header className="pt-32 pb-20 overflow-hidden bg-gradient-to-b from-white to-indigo-50/20 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in-up">
            ...
            {t('title')}
              <span className="text-indigo-600 dark:text-indigo-400">        {t('highlight')}</span>
              {" "}{t("and")} {t('subtitle')}
            </h1>
...
<section id="features" className="bg-white dark:bg-gray-900 bg-gradient-to-b from-white to-indigo-50/20 dark:from-gray-900 dark:to-gray-800">
  <FeatureSection />
</section>
