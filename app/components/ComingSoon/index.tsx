      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-indigo-50 dark:bg-indigo-900/50 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-indigo-600 dark:text-indigo-400">Coming Soon</span>
          </div>
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">
            AI-Powered Social Commerce
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Transform your social media conversations into seamless order processing with our 
            advanced AI technology. No more manual order entry - let our AI handle it for you.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-8">
              <button className="px-8 py-4 bg-indigo-600 dark:bg-indigo-500 text-white rounded-xl font-semibold hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-all duration-300 transform hover:scale-105 shadow-lg">
                Join Waitlist
              </button>
            </div>
          </div>
